...
gramatica = CFG.fromstring("""
    ...
    LET -> 'a' | 'b' | 'c' | 'd' | 'e' | 'f' | 'g' | 'h' | 'i' | 'j' | 'k' | 'l' | 'm' | 'n' | 'o' | 'p' | 'q' | 'r' | 's' | 't' | 'u' | 'v' | 'w' | 'x' | 'y' | 'z' | '_'
    OPER -> '+' | '-' | '*' | '/' | '%'
    OPEN -> IDEN | NUM
""")
...
def AutoPila(cadena):
    ...
    if cadena[0].isalpha():
        for caracter in cadena:
            if estadoActual == 0:
                if caracter.isalpha() and pilaAceptacion.esta_vacia():
                    estadoActual = 1
                else: return False
            elif estadoActual == 1:
                if (caracter.isalpha() or caracter.isdigit()) and ((pilaAceptacion.esta_vacia()) or (pilaAceptacion.cima() == 'I')):
                    estadoActual == 1
                ...
                if caracter.isalpha() and (pilaAceptacion.cima() == 'I'):
                    estadoActual = 1
                ...
                if caracter.isdigit() and (pilaAceptacion.cima() == 'I' or pilaAceptacion.cima() == 'P'):
                    estadoActual = 4
                elif caracter.isalpha() and (pilaAceptacion.cima() == 'I' or pilaAceptacion.cima() == 'P'):
                    estadoActual = 6
                ...
                if (caracter.isdigit() or caracter.isalpha()) and (pilaAceptacion.cima() == 'I' or pilaAceptacion.cima() == 'P'):
                    estadoActual = 6
                elif isOperador(caracter) and (pilaAceptacion.cima() == 'I' or pilaAceptacion.cima() == 'P'):
                    estadoActual = 5
                elif caracter == ')' and pilaAceptacion.cima() == 'P':
